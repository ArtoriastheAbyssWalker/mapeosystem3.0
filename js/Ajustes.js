    ...
    $.ajax({
      ...
      success: function(xml){
        ...
        $("#pestañas").append('<li class="nav-item">'+
                    '<a class="nav-link active bordes" id="home-tab" data-toggle="tab" data-idcampo="campohome" data-textatrea="salida" href="#home" onclick="fnpestaña(this)" role="tab" aria-controls="home" aria-selected="true">General</a>'+
                  '</li>');
  ...
  divisor.forEach(function(i) {
    ...
    for(a=0; a<=tamanio; a++){
      ...
      if( addwords [ a ] == "/></Fields><Tables><Table name=" || addwords [ a ] == "/></Columns></Table><Table name=" || addwords[ a ] == "><Tables><Table name="){
        ...
        $("#pestañas").append('<li class="nav-item">'+
                    '<a class="nav-link" id="profile-' + addwords [ a + 1 ] + '" data-idcampo="campo' + addwords [ a + 1 ] + '" data-textatrea="salida1'+ addwords [ a + 1 ] +'" data-toggle="tab" onclick="fnpestaña(this)" href="#profile" role="tab" aria-controls="' + addwords [ a + 1 ] + '" aria-selected="false">' + addwords [ a + 1 ] + '</a>'
                 +' </li>');
        ...
        $("#cuadros").append('<p id="campo' + addwords [ a + 1 ] + '" class="prueba" style="margin-top: 20px;">Resultado de las lista: ' + addwords [ a + 1 ] + ' ' + addwords [ a + 3 ] + '</p> '+'<textarea class="form-control noresize tamaño10px pruebax" id="salida1'+ addwords[a+1] +'" rows="10" readonly></textarea>');
